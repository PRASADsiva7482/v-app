...
@EnableJpaRepositories(basePackages = "com.va.v.v_app.repository.keycloak", entityManagerFactoryRef = "keycloakEntityManagerFactory", transactionManagerRef = "keycloakTransactionManager")
public class KeycloakDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean keycloakEntityManagerFactory() {
        ...
        em.setPackagesToScan("com.va.v.v_app.persistence.keycloak");
