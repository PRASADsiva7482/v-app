...
import com.va.v.v_app.social.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<com.va.v.v_app.social.dto.response.CursorPageResponse<CommentResponse>> getCommentsWithCursor(
            @PathVariable Long postId,
            Authentication authentication,
    ...
    public ResponseEntity<com.va.v.v_app.social.dto.response.CursorPageResponse<CommentResponse>> getRepliesWithCursor(
            @PathVariable Long commentId,
            Authentication authentication,
            @RequestParam(required = false) Long cursor,
            @RequestParam(defaultValue = "20") int limit) {
