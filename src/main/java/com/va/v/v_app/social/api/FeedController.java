...
import com.va.v.v_app.social.service.FeedService;
...
public class FeedController {
    ...
    public ResponseEntity<com.va.v.v_app.social.dto.response.CursorPageResponse<PostResponse>> getTimelineFeedWithCursor(
            Authentication authentication,
    ...
    public ResponseEntity<com.va.v.v_app.social.dto.response.CursorPageResponse<PostResponse>> getExploreFeedWithCursor(
            Authentication authentication,
            @RequestParam(required = false) Long cursor,
            @RequestParam(defaultValue = "20") int limit) {
        String userId = authentication != null ? authentication.getName() : null;
    ...
    public ResponseEntity<com.va.v.v_app.social.dto.response.CursorPageResponse<PostResponse>> getUserFeedWithCursor(
            @PathVariable String userId,
            Authentication authentication,
            @RequestParam(required = false) Long cursor,
            @RequestParam(defaultValue = "20") int limit) {
